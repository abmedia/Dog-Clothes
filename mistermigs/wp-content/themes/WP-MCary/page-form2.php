      ...
      <div id="inside_contentbox">
	    ...
	    <div id="mainContent1" class="minheight">
		  ...
		  <input type="hidden" name="required" value="Name,Phone,Email">
            ...
            <div id="rform" class="rform">
              <li><label for="Phone" class="required"><strong>Home Number:</strong></label></li>
              <li><input name="Phone" type="text" id="Phone" value="" size="20" /></li>
            </div>
            <div id="rform" class="rform">
            ...
            <div id="rform" class="rform">
              <li><label for="Email"><span class="required"><strong>E-mail Address:</strong></span></label></li>
